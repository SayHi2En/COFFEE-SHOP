            ...
            <div class="row">
                <div class="col-xl-9 mx-auto">
                    <div class="text-center cta-inner rounded">
                        ...
                        <p class="address mb-5"><em><strong>SLSU- BONTOC</strong><span><br>San Ramon, Bontoc Southern Leyte<br></span></em></p>
                        <p class="address mb-0"><small><em>Call Anytime</em></small><span><br>09764753463</span></p>
                    </div>
                </div>
            </div>
        </div>
